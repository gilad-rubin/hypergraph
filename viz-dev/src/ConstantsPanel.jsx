...
const CONSTANT_GROUPS = {
  'Edge Shape': {
    ...
    EDGE_MICRO_X_SNAP:              [6, 0, 20, 1],
  },
  'Edge Penalties': {
    EDGE_ANGLE_WEIGHT:              [1, 0, 10, 0.1],
    EDGE_CURVE_WEIGHT:              [6, 0, 20, 0.5],
    EDGE_TURN_WEIGHT:               [1, 0, 10, 0.1],
    EDGE_LATERAL_WEIGHT:            [0.004, 0, 0.05, 0.001],
    EDGE_NONSTRAIGHT_WEIGHT:        [0.6, 0, 5, 0.1],
    EDGE_NODE_PENALTY:              [30, 0, 100, 1],
    EDGE_NODE_CLEARANCE:            [12, 0, 40, 1],
    EDGE_EDGE_PENALTY:              [20, 0, 100, 1],
    EDGE_EDGE_CLEARANCE:            [10, 0, 40, 1],
    EDGE_SHARED_TARGET_SPACING_SCALE: [1.15, 0.5, 2, 0.05],
  },
  'Feedback Edges': {
    FEEDBACK_EDGE_GUTTER:           [70, 20, 150, 5],
    FEEDBACK_EDGE_HEADROOM:         [40, 10, 100, 5],
    FEEDBACK_EDGE_STEM:             [32, 10, 80, 2],
    FEEDBACK_EDGE_STUB:             [24, 8, 60, 2],
  },
  'Layout': {
    VERTICAL_GAP:                   [100, 40, 200, 5],
    GRAPH_PADDING:                  [24, 8, 48, 2],
    HEADER_HEIGHT:                  [32, 20, 60, 2],
    DATA_NODE_ALIGN_WEIGHT:         [1, 0, 1, 0.05],
    INPUT_NODE_ALIGN_WEIGHT:        [0.9, 0, 1, 0.05],
  },
  'Node Sizing': {
    NODE_BASE_PADDING:              [52, 20, 100, 2],
    FUNCTION_NODE_BASE_PADDING:     [48, 20, 100, 2],
    MAX_NODE_WIDTH:                 [280, 150, 500, 10],
    TYPE_HINT_MAX_CHARS:            [25, 10, 50, 1],
    NODE_LABEL_MAX_CHARS:           [25, 10, 50, 1],
