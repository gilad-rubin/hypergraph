...
def build_index(
    ...
    lines = [
        ...
        "      <input type='range' id='dk-padding' min='0' max='60' step='1' value='16'>",
        "      <span class='value' id='dk-padding-value'>16px</span>",
        "    </div>",
        "  </div>",
    ...
    lines.extend([
        ...
        "      paddingValueEl.textContent = paddingEl.value + 'px';",
