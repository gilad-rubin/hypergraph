...
[**Execution Model**](../../../specs/not_reviewed/architecture/execution-model.md) - Reactive dataflow with versioning
...
[**Control Flow**](../../../specs/not_reviewed/architecture/control-flow.md) - Gates and routing
...
[**Edge Cancels Default**](../../../specs/not_reviewed/architecture/edge-cancels-default.md) - Input resolution rules
...
[**Core Classes**](../../../specs/not_reviewed/architecture/core-classes.md) - Class hierarchy and responsibilities
...
[**Core Types**](../../../specs/not_reviewed/api/types.md) - Complete type reference ⭐ NEW
...
[**Decorators**](../../../specs/not_reviewed/api/decorators.md) - Node and gate decorators
...
[**Graph**](../../../specs/not_reviewed/api/graph.md) - Graph construction and introspection
...
[**Runners**](../../../specs/not_reviewed/api/runners.md) - Execution runtime
...
[**Observability**](../../../specs/not_reviewed/api/observability.md) - Events and integrations ⭐ NEW
...
[**State**](../../../specs/not_reviewed/api/state.md) - GraphState API
...
[**Errors**](../../../specs/not_reviewed/api/errors.md) - Error handling
...
_Start here! See real code first, understand concepts through examples._
...
_For getting oriented: what can I do with hypergraph?_
...
_Why hypergraph exists, what makes it different._
...
* [**Core Types**](../../../specs/not_reviewed/api/types.md) ⭐ - Complete reference for HyperNode, Node, RouteNode, Graph, GraphResult, and all event types
* [**Node Configuration**](../../../specs/not_reviewed/api/node-configuration.md) - `Node()` constructor, `.rename()`, `.map_over()`, builder pattern
* [**Conflict Resolution**](../../../specs/not_reviewed/architecture/conflict-resolution.md) - Parallel producers, sole producer rule, input conflicts

### Expanded Content

* [**Graph API**](../../../specs/not_reviewed/api/graph.md) - Detailed `.bind()` / `.unbind()` documentation, nested graph results with `select` patterns
* [**Runners**](../../../specs/not_reviewed/api/runners.md) - Async execution model, concurrency control, nested runner resolution
* [**Decorators**](../../../specs/not_reviewed/api/decorators.md) - Complete InterruptNode guide with prompt/response types
...
| **Reactive Dataflow**         | [Execution Model](../../../specs/not_reviewed/architecture/execution-model.md)                                                            | Core execution paradigm                     |
| **Edge Cancels Default**      | [Edge Cancels Default](../../../specs/not_reviewed/architecture/edge-cancels-default.md)                                                  | Eliminates entrypoint concept               |
| **Sole Producer Rule**        | [Conflict Resolution](../../../specs/not_reviewed/architecture/conflict-resolution.md#sequential-accumulation-sole-producer-rule)         | Prevents infinite loops in accumulators     |
| **Staleness Detection**       | [Execution Model](../../../specs/not_reviewed/architecture/execution-model.md#staleness-detection)                                        | When to re-execute nodes                    |
| **SyncRunner vs AsyncRunner** | [Runners](../../../specs/not_reviewed/api/runners.md), [Core Classes](../../../specs/not_reviewed/architecture/core-classes.md)           | Pure graph vs execution                     |
| **Gates**                     | [Decorators](../../../specs/not_reviewed/api/decorators.md), [Control Flow](../../../specs/not_reviewed/architecture/control-flow.md)     | Routing and cycles                          |
| **Build-Time Validation**     | [Graph](../../../specs/not_reviewed/api/graph.md), [Conflict Resolution](../../../specs/not_reviewed/architecture/conflict-resolution.md) | Fail fast philosophy                        |
| **Node Configuration**        | [Node Configuration](../../../specs/not_reviewed/api/node-configuration.md)                                                               | `.rename()`, `.map_over()`, builder pattern |
| **Generator Handling**        | [Runners](../../../specs/not_reviewed/api/runners.md#async-execution-model)                                                               | LLM streaming support                       |
| **InterruptNode**             | [Decorators](../../../specs/not_reviewed/api/decorators.md#interruptnode)                                                                 | Human-in-the-loop                           |
| **Runner Compatibility**      | [Runners](../../../specs/not_reviewed/api/runners.md#runner-compatibility-matrix)                                                         | What works where                            |
| **.bind() and Inputs**        | [Graph](../../../specs/not_reviewed/api/graph.md#bind)                                                                                    | Default values, input resolution            |
| **Nested Graphs**             | [Graph](../../../specs/not_reviewed/api/graph.md#nested-graph-results)                                                                    | Composition and result filtering            |
| **Parallel Producers**        | [Conflict Resolution](../../../specs/not_reviewed/architecture/conflict-resolution.md#parallel-producer-conflict)                         | When conflicts occur                        |
| **Core Types**                | [Types](../../../specs/not_reviewed/api/types.md)                                                                                         | All classes and data structures             |
