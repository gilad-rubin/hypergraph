...
### workflow\_id as Idempotency Key
...
The `workflow_id` scopes the cache — run\_002 can find run\_001's cached results because they share the same `workflow_id`.
...
This matches [LangGraph's pending\_writes](https://docs.langchain.com/oss/python/langgraph/persistence) pattern.
...
Inspired by [Mastra's time-travel](https://mastra.ai/docs/v1/workflows/time-travel), [DBOS's fork\_workflow](https://www.dbos.dev/blog/handling-failures-workflow-forks), and [LangGraph's update\_state](https://docs.langchain.com/oss/python/langgraph/use-time-travel).
...
* [Persistence API Reference](../../../specs/api/persistence-api.md) — Complete protocol and type definitions
* [Execution Types](../../../specs/api/execution-types.md) — Events and runtime types
* [Runners](../../../specs/api/runners.md) — How runners integrate with persistence
