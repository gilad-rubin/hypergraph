...
> **Looking for concepts and examples?** See [Persistence & Durable Execution](../../../specs/architecture/persistence.md) first.
...
| Type                                                              | Purpose                          |
| ----------------------------------------------------------------- | -------------------------------- |
| [StepIdentity](persistence-api.md#stepidentity)                   | Hierarchical step addressing     |
| [StepSnapshot](persistence-api.md#stepsnapshot)                   | Step execution record            |
| [StepAttempt](persistence-api.md#stepattempt)                     | Single retry attempt             |
| [PendingWrite](persistence-api.md#pendingwrite)                   | Partial batch completion         |
| [StreamingState](persistence-api.md#streamingstate)               | Incremental stream progress      |
| [StreamPersistenceMode](persistence-api.md#streampersistencemode) | When to persist streaming chunks |
| [Checkpoint](persistence-api.md#checkpoint)                       | Full workflow state snapshot     |
| [Checkpointer](persistence-api.md#checkpointer-protocol)          | Persistence interface            |
| [RetryPolicy](persistence-api.md#retrypolicy)                     | Retry configuration              |
| [WorkflowReusePolicy](persistence-api.md#workflowreusepolicy)     | Workflow ID reuse behavior       |
| [Serializer](persistence-api.md#serializer-protocol)              | Custom serialization             |
| [PayloadLimits](persistence-api.md#payloadlimits)                 | Size constraints                 |
| [Lease](persistence-api.md#lease)                                 | Distributed step locking         |
...
* [Persistence & Durable Execution](../../../specs/architecture/persistence.md) — Conceptual guide
* [Execution Types](../../../specs/deprecated/execution-types.md) — Runtime events and state
