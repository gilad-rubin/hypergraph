...
def _instance_factories() -> dict[str, object]:
    ...
    factories: dict[str, object] = {
        ...
        "hypergraph.runners._shared.run_log.RunLog": lambda: run_log,
        "hypergraph.runners._shared.run_log.MapLog": lambda: MapLog(graph_name="g", total_duration_ms=1.0, items=(run_log,)),
