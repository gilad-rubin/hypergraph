...
class TestGenerateHtml:
    ...
    def test_returns_string(self):
        ...
        html = generate_html(SAMPLE_GRAPH_DATA)
    ...
    def test_contains_custom_styles(self):
        ...
        # Should have Tailwind CSS
        assert "tailwind" in html.lower() or "text-slate" in html
    ...
    def test_custom_dimensions(self):
        """Test that width and height parameters are accepted."""
        html = generate_html(SAMPLE_GRAPH_DATA, width=1200, height=800)
