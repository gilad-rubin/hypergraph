...
class TestIdSanitization:
    """Tests for Mermaid reserved-word and unsafe-ID handling."""

    def test_reserved_word_prefixed(self):
        """Nodes named after Mermaid reserved words get n_ prefix."""
        from hypergraph.viz.mermaid import _sanitize_id
    ...
    def test_digit_leading_id_prefixed(self):
        ...
        assert _sanitize_id("123_node") == "n_123_node"
