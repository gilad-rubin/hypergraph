# @generated by scripts/gen_sync.py from template_async.py — DO NOT EDIT.
#
...
class SyncRunnerTemplate(BaseRunner, ABC):
    ...
    def run(
        ...
        **input_values: Any,
        ...
        try:
            if sync_cp is not None and _validation_ctx is None:
                ...
                if fork_from is not None:
                    workflow_id, resume_checkpoint = sync_cp.fork_workflow(
                        fork_from,
                        workflow_id=workflow_id,
                    )
                    candidate_checkpoint = resume_checkpoint
                elif retry_from is not None:
                    workflow_id, resume_checkpoint = sync_cp.retry_workflow(
                        retry_from,
                        workflow_id=workflow_id,
                    )
                    candidate_checkpoint = resume_checkpoint
        ...
        has_checkpointer = sync_cp is not None and workflow_id is not None
    ...
    def map(
        ...
        **input_values: Any,
        ...
        def _run_map_item(idx: int, variation_inputs: dict[str, Any]) -> RunResult:
