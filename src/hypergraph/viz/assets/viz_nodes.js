...
(function(root) {
  ...
  var Icons = {
    ...
    // A ─▶ B ─▶ C chain with the redundant A ─▶ C shortcut arcing past it;
    // the shortcut is dashed because "simplify" is what hides it.
    Simplify: function() { return html`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4"><circle cx="7" cy="4" r="2"></circle><circle cx="7" cy="12" r="2"></circle><circle cx="7" cy="20" r="2"></circle><path d="M7 6v4"></path><path d="M7 14v4"></path><path d="M9.5 4.8c5 2.2 5 12.2 0 14.4" strokeDasharray="3 2.5"></path></svg>`; },
