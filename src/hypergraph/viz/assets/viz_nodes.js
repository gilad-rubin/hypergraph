...
(function(root) {
  ...
  var Icons = {
    ...
    // A -> B -> C chain with the shortcut A -> C arcing past it, dashed
    // because "simplify" is what hides it. Geometry is
    // centred on purpose: circles at cx=10.65 (left edge 8.75) and the arc
    // peaking at 15.25 put the ink's midpoint at exactly 12, the viewBox
    // centre. The previous version sat 1.9px left of centre at 16px render.
    Simplify: function() { return html`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4"><circle cx="10.65" cy="5" r="1.9"></circle><circle cx="10.65" cy="12" r="1.9"></circle><circle cx="10.65" cy="19" r="1.9"></circle><path d="M10.65 6.9v3.2"></path><path d="M10.65 13.9v3.2"></path><path d="M12.55 6.2q5.4 5.8 0 11.6" strokeDasharray="2.5 2.5" opacity="0.55"></path></svg>`; },
